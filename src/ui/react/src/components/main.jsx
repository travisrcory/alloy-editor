(function () {
    ...
    var UI = React.createClass({
        ...
        componentDidMount: function () {
            ...
            this._keyUpListener = CKEDITOR.tools.debounce(function(event) {
         ...
         * the editable area or the target was already detached from the DOM.
         * If none of these, sets the state of editor to be hidden.
         *
